        ...
        <AppStateProvider>
          <SidebarProvider>
            ...
            <SidebarInset className="scroll-smooth">
              <DssMain className="flex justify-center min-h-[calc(100vh-var(--header-height)-var(--footer-height))] min-w-200 overflow-x-hidden p-4 pb-[calc(var(--footer-height)+0.1rem)] mx-auto overflow-hidden bg-brand-blue-gray">
                <Routes>
